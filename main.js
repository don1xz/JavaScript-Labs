...
function calculateAverageTransactionAmount(transactions) {
  if (transactions.length === 0) return 0; // сделал обычную проверку
  return calculateTotalAmount(transactions) / transactions.length; // поделил па общее колво элементов
}
...
console.log("Сумма за январь 2024:", calculateTotalAmountByDate(transactions, 2024, 1));
console.log("Сумма за 10 марта 2024:", calculateTotalAmountByDate(transactions, 2024, 3, 10));
console.log("Дебетовые транзакции:", getTransactionByType(transactions, "debit"));
console.log("Диапазон дат (фев–март):", getTransactionsInDateRange(transactions, "2024-02-01", "2024-03-15"));
console.log("Транзакции SuperMart:", getTransactionsByMerchant(transactions, "SuperMart"));
console.log("Средняя сумма:", calculateAverageTransactionAmount(transactions));
console.log("Итого дебет:", calculateTotalDebitAmount(transactions));
...
console.log("Преобладающий тип:", mostTransactionTypes(transactions));
console.log("До 2024-02-01:", getTransactionsBeforeDate(transactions, "2024-02-01"));
console.log("Транзакция 5:", findTransactionById(transactions, "5"));
...
console.log("Месяц макс. транзакций:", findMostTransactionsMonth(empty));
console.log("Преобладающий тип:", mostTransactionTypes(empty));
...
const single = [
  {
    ...
    transaction_type: "debit",
    transaction_description: "Single item",
    merchant_name: "Solo Shop",
    card_type: "debit",
  },
];
console.log("\n--- Одна транзакция ---");
console.log("Уникальные типы:", getUniqueTransactionTypes(single));
console.log("Общая сумма:", calculateTotalAmount(single));
console.log("Средняя сумма:", calculateAverageTransactionAmount(single));
console.log("Месяц макс. транзакций:", findMostTransactionsMonth(single));
console.log("Преобладающий тип:", mostTransactionTypes(single));